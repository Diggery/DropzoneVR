...
abstract public class IVRPointer : MonoBehaviour {
    ...
    void Start()
    {
        ...
        if(VRInputModule.instance == null) {
            new GameObject().AddComponent<VRInputModule>();
        }



        inputModule = VRInputModule.instance;
        inputModule.AddController(this);
    }
    ...
    protected virtual void Update()
    {
        ...
        RaycastHit hitInfo;
        bool bHit = Physics.Raycast(ray, out hitInfo, VRInputModule.instance.layerMask);
