...
public class VRInputModule : BaseInputModule {
    ...
    private HashSet<IVRPointer> _controllers;
    // controller data
    private Dictionary<IVRPointer, ControllerData> _controllerData = new Dictionary<IVRPointer, ControllerData>();
    ...
    public void AddController(IVRPointer controller)
    {
        _controllerData.Add(controller, new ControllerData());
    }

    public void RemoveController(IVRPointer controller)
    {
        _controllerData.Remove(controller);
    }

    protected void UpdateCameraPosition(IVRPointer controller)
    {
        UICamera.transform.position = controller.GetPosition();
        UICamera.transform.rotation = controller.GetRotation();
    }
    ...
    public override void Process()
    {
        ...
        foreach(var pair in _controllerData) {
            IVRPointer controller = pair.Key;
